...
namespace ss
{
	...
	void Player::Initialize()
	{
		...
		anim->Create(L"Player_G_overload_Attack1R", Image47, Vector2(0.f, 0.f), Vector2(105.f, 57.f), 8, Vector2(240.f, 50.f), Vector2(12.f, -7.f), 0.04f); // 0.04로 하기 
		anim->Create(L"Player_G_overload_Attack1L", Image47, Vector2(0.f, 0.f), Vector2(105.f, 57.f), 8, Vector2(240.f, 50.f), Vector2(-2.f, -7.f), 0.04f, true);

		anim->Create(L"Player_G_overload_Attack2R", Image48, Vector2(0.f, 0.f), Vector2(105.f, 57.f), 8, Vector2(240.f, 50.f), Vector2(10.f, -7.f), 0.04f);
		anim->Create(L"Player_G_overload_Attack2L", Image48, Vector2(0.f, 0.f), Vector2(105.f, 57.f), 8, Vector2(240.f, 50.f), Vector2(0.f, -7.f), 0.04f, true);
