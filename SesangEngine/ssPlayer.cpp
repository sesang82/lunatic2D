...
namespace ss
{
	...
	void Player::Initialize()
	{
		...
		// 맞았을 때 
		anim->Create(L"Player_S_HitR", Image14, Vector2(0.f, 0.f), Vector2(105.f, 57.f), 4, Vector2(107.f, 58.f), Vector2(0.f, -6.5f), 0.12f);
		anim->Create(L"Player_S_HitL", Image14, Vector2(0.f, 0.f), Vector2(105.f, 57.f), 4, Vector2(107.f, 58.f), Vector2(0.f, -6.5f), 0.12f, true);
