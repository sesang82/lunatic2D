                     ...
                     _In_ int       nCmdShow)
{
    ...
    // 
     SetProcessDPIAware(); // 배율이 어떻든 알아서 해줌 
    // 
    // 
    // TODO: 여기에 코드를 입력합니다.
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      CW_USEDEFAULT, 0, 1600, 896, nullptr, nullptr, hInstance, nullptr);
   ...
   // 픽셀 갯수 맞춤
   application.SetWindow(hWnd, 1600, 896);
   ShowWindow(hWnd, nCmdShow);
   UpdateWindow(hWnd);

   application.Initialize();
   ss::InitializeScenes(); // load할 Scene들이 모인 곳
